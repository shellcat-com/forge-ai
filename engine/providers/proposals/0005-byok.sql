-- TASK04 PROPOSAL ONLY. Task01 owns migration numbering/publication and review.
-- Native tests apply this to a disposable E1 database; no production runner loads it.
SET search_path=forge_control,pg_catalog;
