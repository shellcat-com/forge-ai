...
import '../../src/cloud/legacy-shell.css'
...
const development = (import.meta as ImportMeta & { readonly env?: { readonly DEV?: boolean } }).env?.DEV
if (!development) throw new Error('UI_FIXTURE_DEVELOPMENT_ONLY')
