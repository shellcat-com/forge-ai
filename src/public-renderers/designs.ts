    ...
    !id
      ...
      : p
        ...
        : recovery(
            ...
            'Explore the five optional examples to find your direction.'
          )
  }</main>${footer()}</div>`
}
