...
export function topbar(): string {
  return `<header class="public-nav">${brand()}<nav aria-label="Main navigation"><a href="#/presets">Examples</a><a href="#/docs">Documentation</a><a href="#/projects">Workspace ↗</a></nav><div class="nav-actions">${themes()}<a class="button primary" href="#/login">Start building <span>↗</span></a><button class="menu-toggle" data-action="menu" aria-expanded="false" aria-controls="mobile-nav" aria-label="Open navigation">☰</button></div></header><nav id="mobile-nav" class="mobile-nav" aria-label="Mobile navigation" hidden><a href="#/presets">Examples</a><a href="#/docs">Documentation</a><a href="#/projects">Workspace</a></nav>`
}
export function footer(): string {
  return `<footer class="footer"><div>${brand()}<p>Shape the idea. Forge the system.</p></div><nav aria-label="Footer"><a href="#/docs">Documentation ↗</a><a href="#/presets">Examples</a><a href="#/components">Components</a><a href="#/settings">Local data</a></nav><div class="footer-bottom"><span>© ${new Date().getFullYear()} Forge AI · Pre-alpha</span><span>Built with intention.</span>${themes()}</div></footer>`
}
